...
<blockquote> Collection of personal <strong>CG</strong> projects. Include real-time shaders / renders and other fun stuff..  </blockquote>
<hr />
...
query IndexPage {
  ...
  markdownRemark(frontmatter: {templateKey: {eq: "pro-page"}}) {
    frontmatter {
      title
      description
      thumbnail {
